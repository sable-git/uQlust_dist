...
namespace Graph
{
    public partial class HashClusterForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            localInput.profileNameReg = localInput.profileName;
            ...
            if (!jury1DSetup1.inputMode.Contains(mode))
            {
                MessageBox.Show("Profile " + jury1DSetup1.profileName + " cannot be used in " + mode);
                this.DialogResult = DialogResult.None;
                return;
            }
