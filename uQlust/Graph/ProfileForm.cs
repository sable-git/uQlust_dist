    ...
    {        
        ...
        private void profilesView_DrawNode(object sender, DrawTreeNodeEventArgs e)
        {
            ...
            if ((e.State & TreeNodeStates.Selected) != 0)
                ...
                if (e.Node.Tag == null || ((profileNode)e.Node.Tag).active)
        ...
        {
            ActiveNode();
            profilesView.SelectedNode = profilesView.Nodes[0];
        }
        ...
        {
            treeProfiles.combine = profileCombination.JOIN_STATES;
            AddProfile();
            toolStripButton1.Enabled = false;
        ...
        {
            treeProfiles.combine = profileCombination.JOIN_PROFILES;
            AddProfile();
            toolStripButton4.Enabled = false;
        }
    }
